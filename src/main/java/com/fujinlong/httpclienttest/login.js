...
function ptuiCB(t, e, i, n, o) {
    ...
    case "22009":
        pt.plogin.force_qrlogin(),
        pt.plogin.isNewStyle && (pt.qlogin.buildQloginList([], 10006 == t ? 2 : 1), pt.plogin.begin_qrlogin()),
        pt.plogin.check();
        break;
    case "10008":
    ...
    if (0 != t && s && pt.plogin.show_err(o, l), !pt.plogin.hasCheck() && s && (pt.plogin.needShowNewVc || (pt.plogin.showVC(), $("verifycode").focus(), $("verifycode").select())), Math.random() < .2) {
        ...
        var a = 1;
        pt.ptui.isHttps && (a = 2);
        var c = "flag1=7808&flag2=7&flag3=2&" + a + "=" + (pt.plogin.isdTime["7808-7-2-1"] - pt.plogin.isdTime["7808-7-2-0"]);
...
$.e = {
    ...
    _find: function(t, e, i) {
        ...
        r = n.length - 1; r >= 0; r--) {
            var s = n[r],
            l = p._allHandlers[s];
            if (l.eventType == e && l.handler == i) return r
        }
        return - 1
    },
...
$.css = function() {
    ...
    return {
        ...
        updateClass: function(t, e, i) {
            ...
            if (i) {
                var l = i.split(" ");
                for (p = 0, r = l.length; r > p; p++) l[p] && delete o[l[p]]
            }
            var a = [];
...
$.animate = {
    fade: function(t, e, i, n, o) {
        if (t = $(t)) {
            ...
            a = l(t),
            c = r > a ? 1 : -1; - 1 != s.indexOf("msie") && 15 > n && (i = Math.floor(15 * i / n), n = 15);
            var u = function() {
                a += i * c,
                (Math.round(a) - r) * c >= 0 ? (t.style.opacity = r / 100, t.style.filter = "alpha(opacity=" + r + ")", window.clearInterval(t.effect.fade), "function" == typeof o && o(t)) : (t.style.opacity = a / 100, t.style.filter = "alpha(opacity=" + a + ")")
            };
    ...
    animate: function(t, e, i, n, o) {
        if (t = $(t)) {
            ...
            if ( - 1 == c.indexOf("msie") || "BackCompat" != document.compatMode) {
                ...
                "number" == typeof g && (a.push("width"), e.width = g - u.paddingLeft.replace(/\D/g, "") - u.paddingRight.replace(/\D/g, "")),
                "number" == typeof d && (a.push("height"), e.height = d - u.paddingTop.replace(/\D/g, "") - u.paddingBottom.replace(/\D/g, "")),
                15 > n && (i = Math.floor(15 * i / n), n = 15)
            }
            var h = e.left || 0 == e.left ? parseInt(e.left) : null,
            f = e.top || 0 == e.top ? parseInt(e.top) : null;
            "number" == typeof h && (a.push("left"), t.style.position = "absolute"),
            "number" == typeof f && (a.push("top"), t.style.position = "absolute");
            for (var m = [], _ = a.length, p = 0; _ > p; p++) m[a[p]] = l[a[p]] < e[a[p]] ? 1 : -1;
            var v = t.style,
            w = function() {
                for (var n = !0,
                p = 0; _ > p; p++) l[a[p]] = l[a[p]] + m[a[p]] * Math.abs(e[a[p]] - l[a[p]]) * i / 100,
                (Math.round(l[a[p]]) - e[a[p]]) * m[a[p]] >= 0 ? (n = n && !0, v[a[p]] = e[a[p]] + "px") : (n = n && !1, v[a[p]] = l[a[p]] + "px");
...
$.RSA = $pt.RSA = function() {
    ...
    function E(t, e, i) {
        ...
        if (! (n.t <= 0)) {
            ...
            if (0 != g) {
                ...
                null != e && (i.drShiftTo(u, e), l != a && r.ZERO.subTo(e, e)),
                i.t = u,
                i.clamp(),
                c > 0 && i.rShiftTo(c, i),
    ...
    st && "Microsoft Internet Explorer" == navigator.appName ? (r.prototype.am = a, pt = 30) : st && "Netscape" != navigator.appName ? (r.prototype.am = l, pt = 26) : (r.prototype.am = c, pt = 28),
    r.prototype.DB = pt,
...
function(t) {
    ...
    function u(t) {
        for (var e = 16,
        o = i(t, 0, 4), p = i(t, 4, 4), r = i(f, 0, 4), s = i(f, 4, 4), l = i(f, 8, 4), a = i(f, 12, 4), c = 0, u = 2654435769; e-->0;) c += u,
        c = (4294967295 & c) >>> 0,
        o += (p << 4) + r ^ p + c ^ (p >>> 5) + s,
        o = (4294967295 & o) >>> 0,
        p += (o << 4) + l ^ o + c ^ (o >>> 5) + a,
    ...
    function g(t) {
        for (var e = 16,
        o = i(t, 0, 4), p = i(t, 4, 4), r = i(f, 0, 4), s = i(f, 4, 4), l = i(f, 8, 4), a = i(f, 12, 4), c = 3816266640, u = 2654435769; e-->0;) p -= (o << 4) + l ^ o + c ^ (o >>> 5) + a,
        p = (4294967295 & p) >>> 0,
        o -= (p << 4) + r ^ p + c ^ (p >>> 5) + s,
        o = (4294967295 & o) >>> 0,
        c -= u,
...
pt.qlogin = function() {
    ...
    q = function(t) {
        function e() {
            $("qlogin_list").style.left = 1 == t ? s * p - h * o + "px": (2 - h) * o - s * p + "px",
            s++,
    ...
    S = function() {
        if (s.length = 0, $.suportActive()) try {
            ...
            for (var o = i.GetArray("PTALIST"), p = o.GetSize(), r = 0; p > r; r++) {
                var a = o.GetData(r),
                c = a.GetDWord("dwSSO_Account_dwAccountUin"),
                u = a.GetDWord("dwSSO_Account_dwAccountUin"),
                g = "",
                d = a.GetByte("cSSO_Account_cAccountType"),
                h = c;
                if (1 == d) try {
                    g = a.GetArray("SSO_Account_AccountValueList"),
                    h = g.GetStr(0)
                } catch(f) {}
                var m = 0;
                try {
                ...
                for (var v = a.GetBuf("bufST_PTLOGIN"), w = "", y = v.GetSize(), b = 0; y > b; b++) {
                    var k = v.GetAt(b).toString("16");
                    1 == k.length && (k = "0" + k),
                    w += k
                }
                var q = a.GetDWord("dwSSO_Account_dwUinFlag"),
                S = {
                    uin: c,
                    name: h,
                    uinString: u,
            ...
            0 == p && (__pt_ieZeroLogin = !0, T(), $.report.monitor(2129652, 1))
        } catch(f) {
            T(),
            ...
            if (0 != x) {
                ...
                "function" == typeof C.GetKeyIndex && (l = C.GetKeyIndex())
            }
    ...
    x = function(t) {
        if (t) {
            ...
            k = setInterval(function() {
                p >= n.length || window.ptui_getst_CB && ptui_getst_CB.called ? clearInterval(k) : $.http.loadScript(i.replace("[port]", n[p++])),
    ...
    A = function(t) {
        ...
        if (pt.plogin.authUin && "0" == pt.ptui.auth_mode) {
            var p = {};
            p.name = pt.plogin.authUin,
            p.uinString = pt.plogin.authUin,
            p.nick = $.str.utf8ToUincode($.cookie.get("ptnick_" + pt.plogin.authUin)) || pt.plogin.authUin,
            p.loginType = i,
            e.push(p)
        }
        for (var l = 0; n > l; l++) {
            var a = s[l]; (!pt.plogin.authUin || pt.plogin.authUin != a.name && pt.plogin.authUin != a.uinString) && e.push(a)
        }
        return r = e,
        e
    },
    ...
    E = function(t, e) {
        ...
        if (null != l) {
            ...
            if (40 == pt.ptui.style) var h = s.length;
            else var h = s.length > f ? f: s.length;
            if (0 == h) return void pt.plogin.switchpage(1, !0);
            for (var m = 0; m < (e ? 1 : s.length); m++)(s[m].loginType == p || s[m].loginType == n) && (pt.qlogin.hasBuildQlogin = !0);
            if (40 == pt.ptui.style ? N(e, h) : pt.plogin.isNewQr && (1 == h && pt.plogin.isNewQr ? ($("qlogin_tips") && $.css.hide($("qlogin_tips")), $("qlogin_show").style.top = "25px") : ($("qlogin_tips") && $.css.show($("qlogin_tips")), $("qlogin_show").style.top = "")), 40 == pt.ptui.style && (g = Math.floor(($("qlogin_show").offsetWidth || d) / 100)), u = Math.ceil(h / g), 40 == pt.ptui.style) {
                var _ = $("qlogin_show");
                _.style.width = 100 * g + "px",
                _.style.left = "50%",
                _.style.marginLeft = 50 * -g + "px"
            }
            u >= 2 && $.css.show($("nextPage"));
            for (var v = 0; h > v; v++) {
                var w = s[v],
                y = $.str.encodeHtml(w.uinString + ""),
                b = $.str.encodeHtml(w.nick);
                "" == $.str.trim(w.nick) && (b = y);
                var k = w.flag,
                q = 4 == (4 & k),
                S = pt.plogin.dftImg;
                if (w.loginType == o) {
                    var c = $("qr_area");
                    1 == h ? (c && ($("qr_area").className = "qr_0"), "1033" == pt.ptui.lang && ($("qlogin_show").style.height = $("qlogin_show").offsetHeight + 10 + "px")) : c && ($("qr_area").className = "qr_1")
                } else r += a.replace(/#uin#/g, y).replace(/#nick#/g,
                function() {
                    return b
                }).replace(/#nick_class#/, q ? "nick red": "nick").replace(/#vip_logo#/, q ? "vip_logo": "").replace(/#type#/g, w.loginType).replace(/#src#/g, S).replace(/#tabindex#/, v + 1).replace(/#class#/g, w.loginType == i ? "auth": "hide")
            }
            r = l.innerHTML + r,
            l.innerHTML = r,
            setTimeout(function() {
                var t = $("qlogin_show").offsetWidth || d;
                if (40 != pt.ptui.style) var e = 1 == u ? t: t / g * h;
                else var e = 1 == u ? t: 100 * h;
                l.style.width = e + "px",
                pt.plogin.isNewQr && (l.style.width = e + 4 + "px")
            },
            0),
            F(),
            z()
    ...
    Q = function(t) {
        var e = pt.ptui.s_url;
        return 1 == pt.ptui.low_login && pt.plogin.low_login_enable && pt.plogin.isMailLogin && (e = P(e, "ss", 1)),
        pt.plogin.isMailLogin && t && (e = P(e, "account", encodeURIComponent(t))),
        e
    },
    I = function(t) {
        ...
        return i += "clientuin=" + t.uin + "&keyindex=" + l + "&pt_aid=" + pt.ptui.appid + (pt.ptui.daid ? "&daid=" + pt.ptui.daid: "") + "&u1=" + encodeURIComponent(Q()),
    ...
    M = function() {
        ...
        return t += "&regmaster=" + pt.ptui.regmaster + "&aid=" + pt.ptui.appid + "&s_url=" + encodeURIComponent(Q()),
    ...
    W = function() {
        for (var t = r.length,
        e = 0; t > e; e++) r[e].uinString && $.http.loadScript((pt.ptui.isHttps ? "https://ssl.ptlogin2.": "http://ptlogin2.") + pt.ptui.domain + "/getface?appid=" + pt.ptui.appid + "&imgtype=3&encrytype=0&devtype=0&keytpye=0&uin=" + r[e].uinString + "&r=" + Math.random())
    },
    X = function() {
        G(),
        setTimeout(function() {
...
pt.plogin = {
    ...
    initQlogin: function(t, e) {
        ...
        pt.plogin.isPwdFirst() && setTimeout(function() {
    ...
    switchpage: function(t, e) {
        ...
        window.setTimeout(function() {
            try {
                ...
                $("switch_bottom") && ($("switch_bottom").style.left = i + "px"),
                $("switch_bottom") && ($("switch_bottom").style.width = n + "px")
            }
        },
        100),
        pt.plogin.ptui_notifySize("login")
    ...
    domLoad: function(t) {
        if (!pt.plogin.hasDomLoad) {
            ...
            !pt.plogin.isNewStyle || pt.qlogin.hasBuildQlogin || pt.plogin.isPwdFirst() || pt.plogin.showQrTips(),
            pt.plogin.isNewStyle && window.scrollTo(0, 0)
        }
    },
    dottedShow: function() {
        try {
    ...
    armSafeEdit: function() {
        function t() {
            ...
            pt.plogin.armSafeEdit.isSafe = !1;
                ...
                var t = $("safe_edit");
                t ? a.style.display = "block": (a.innerHTML = ($.suportActive() ? c: u) + g, e.appendChild(a), t = $("safe_edit"), $.e.add(t, "focus", pt.plogin.check));
                try {
                    t.CreateSafeEdit(),
                    t.ClearAllInput(),
                    setTimeout(function() {
